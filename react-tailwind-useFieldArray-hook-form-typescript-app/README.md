...
- [tailwind.ink](https://tailwind.ink/code)
- [ブックマークしているイラスト・アイコン素材サービスを共有します](https://zenn.dev/d0ne1s/articles/00d2be0215c7701bea78)
- [食べ物のイラスト一覧](https://illustrain.com/?cat=80)